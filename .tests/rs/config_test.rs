...
fn test_ai_services_default_urls() {
    ...
    assert_eq!(config.ai_services.data_query_url, "http://localhost:8002");
    assert_eq!(config.ai_services.knowledge_assets_url, "http://localhost:8003");
    assert_eq!(config.ai_services.mcp_tools_url, "http://localhost:8004");
    assert_eq!(config.ai_services.bpa_url, "http://localhost:8005");
